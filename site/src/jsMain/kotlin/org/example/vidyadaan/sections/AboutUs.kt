...
@Composable
fun AboutUs() {
    Box(modifier = Modifier.fillMaxWidth().margin(topBottom = 40.px) , contentAlignment = Alignment.Center) {
        Column(modifier = aboutUsContainer.toModifier() , horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Column(modifier = Modifier.fillMaxWidth().margin(bottom = 20.px)) {
                SpanText(
                    text = "Vidyadaan", modifier = Modifier.fontFamily("poppins")
            ...
            SpanText(text = aboutuscontent ,modifier = Modifier.fontFamily("poppins")
